/**
 * /integrations/n8n — n8n integration page
 *
 * High-DR backlink target + AI-citation landing page. Each integration
 * page targets the keyword cluster around "n8n + lead data" or
 * "n8n integration for cold outreach."
 */
...
export const metadata: Metadata = {
  title: "n8n Integration — Push Verified Owner Mobiles into n8n | Leadity",
  description:
    "Native n8n integration. Self-hosted automation for cold-outreach teams. Trigger Leadity scrapes from n8n workflows, route results through enrichment + dialer. Verified owner-direct mobiles, mobile-only filter, TCPA-aware export.",
  alternates: { canonical: "https://leadity.io/integrations/n8n" },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "n8n + Leadity: Verified Owner Mobiles in Your n8n Workflow",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "n8n", item: "https://leadity.io/integrations/n8n" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <p className="mt-6 text-xl leading-relaxed text-[var(--color-text-secondary)]">
          Verified owner-direct mobile numbers in your n8n workflow.
          n8n is a open-source workflow automation — Self-hosted automation for cold-outreach teams. Trigger Leadity scrapes from n8n workflows, route results through enrichment + dialer.
        </p>
        ...
        <ol className="mt-4 space-y-3 text-base list-decimal list-inside">
          ...
          <li>
            <strong>Leadity export node</strong> — when the export completes,
            Leadity fires the node into n8n.
          </li>
          <li>
            <strong>Output to next node — Smartlead, Instantly, Lemlist, your CRM, or any HTTP webhook.</strong>
          </li>
          <li>
            <strong>Run outreach</strong> — DNC-scrubbed mobiles flow into your
            existing n8n workflows for dialing, SMS, or sequencing.
          </li>
        </ol>

        <h2 className="text-2xl font-bold mt-12">Why pair n8n with Leadity</h2>
        <ul className="mt-4 space-y-3 text-base">
          <li>
            <strong>Mobile-only data.</strong> 84%+ verified mobile rate via
            carrier HLR. n8n workflows don't waste sends on landlines.
          </li>
          <li>
            <strong>TCPA flags inline.</strong> DNC + line-type tags pass
            through to n8n as custom properties / fields. Build automations
            that respect compliance automatically.
          </li>
          <li>
            <strong>Flat pricing.</strong> $59 for 2,000 mobiles. No credit
            math — your n8n cost stays predictable.
          </li>
        </ul>

        <h2 className="text-2xl font-bold mt-12">Set it up</h2>
        <p className="mt-4 text-base">
          The n8n integration ships in Phase 8 production. The
          self-serve flow lives at <Link href="/dashboard" className="text-[#1B86FF] underline">
          /dashboard → Integrations → n8n</Link>. For early access, reach
        ...
        <div className="mt-16 p-8 bg-[var(--color-surface)] rounded-2xl text-center">
          <h2 className="text-2xl font-bold">
            Try Leadity + n8n — 50 mobiles free
          </h2>
