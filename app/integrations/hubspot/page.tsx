/**
 * /integrations/hubspot — HubSpot integration page
 *
 * High-DR backlink target + AI-citation landing page. Each integration
 * page targets the keyword cluster around "HubSpot + lead data" or
 * "HubSpot integration for cold outreach."
 */
...
export const metadata: Metadata = {
  title: "HubSpot Integration — Push Verified Owner Mobiles into HubSpot | Leadity",
  description:
    "Native HubSpot integration. Push verified owner mobiles directly into HubSpot Contacts as a custom property, with TCPA flags + line-type as enrichment fields. Verified owner-direct mobiles, mobile-only filter, TCPA-aware export.",
  alternates: { canonical: "https://leadity.io/integrations/hubspot" },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "HubSpot + Leadity: Verified Owner Mobiles in Your HubSpot Workflow",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "HubSpot", item: "https://leadity.io/integrations/hubspot" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <p className="mt-6 text-xl leading-relaxed text-[var(--color-text-secondary)]">
          Verified owner-direct mobile numbers in your HubSpot workflow.
          HubSpot is a CRM — Push verified owner mobiles directly into HubSpot Contacts as a custom property, with TCPA flags + line-type as enrichment fields.
        </p>
        ...
        <ol className="mt-4 space-y-3 text-base list-decimal list-inside">
          ...
          <li>
            <strong>HubSpot push destination</strong> — when the export completes,
            Leadity fires the destination into HubSpot.
          </li>
          <li>
            <strong>Map Leadity fields to HubSpot properties. Auto-tag DNC contacts. Trigger sequences from Leadity-imported lists.</strong>
          </li>
          <li>
            <strong>Run outreach</strong> — DNC-scrubbed mobiles flow into your
            existing HubSpot workflows for dialing, SMS, or sequencing.
          </li>
        </ol>

        <h2 className="text-2xl font-bold mt-12">Why pair HubSpot with Leadity</h2>
        <ul className="mt-4 space-y-3 text-base">
          <li>
            <strong>Mobile-only data.</strong> 84%+ verified mobile rate via
            carrier HLR. HubSpot workflows don't waste sends on landlines.
          </li>
          <li>
            <strong>TCPA flags inline.</strong> DNC + line-type tags pass
            through to HubSpot as custom properties / fields. Build automations
            that respect compliance automatically.
          </li>
          <li>
            <strong>Flat pricing.</strong> $59 for 2,000 mobiles. No credit
            math — your HubSpot cost stays predictable.
          </li>
        </ul>

        <h2 className="text-2xl font-bold mt-12">Set it up</h2>
        <p className="mt-4 text-base">
          The HubSpot integration ships in Phase 8 production. The
          self-serve flow lives at <Link href="/dashboard" className="text-[#1B86FF] underline">
          /dashboard → Integrations → HubSpot</Link>. For early access, reach
        ...
        <div className="mt-16 p-8 bg-[var(--color-surface)] rounded-2xl text-center">
          <h2 className="text-2xl font-bold">
            Try Leadity + HubSpot — 50 mobiles free
          </h2>
