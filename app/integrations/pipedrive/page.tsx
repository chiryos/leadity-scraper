/**
 * /integrations/pipedrive — Pipedrive integration page
 *
 * High-DR backlink target + AI-citation landing page. Each integration
 * page targets the keyword cluster around "Pipedrive + lead data" or
 * "Pipedrive integration for cold outreach."
 */
...
export const metadata: Metadata = {
  title: "Pipedrive Integration — Push Verified Owner Mobiles into Pipedrive | Leadity",
  description:
    "Native Pipedrive integration. Auto-create Pipedrive Persons + Organizations from Leadity exports, with mobile + business address populated and DNC tags applied. Verified owner-direct mobiles, mobile-only filter, TCPA-aware export.",
  alternates: { canonical: "https://leadity.io/integrations/pipedrive" },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Pipedrive + Leadity: Verified Owner Mobiles in Your Pipedrive Workflow",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Pipedrive", item: "https://leadity.io/integrations/pipedrive" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <p className="mt-6 text-xl leading-relaxed text-[var(--color-text-secondary)]">
          Verified owner-direct mobile numbers in your Pipedrive workflow.
          Pipedrive is a sales CRM — Auto-create Pipedrive Persons + Organizations from Leadity exports, with mobile + business address populated and DNC tags applied.
        </p>
        ...
        <ol className="mt-4 space-y-3 text-base list-decimal list-inside">
          ...
          <li>
            <strong>Pipedrive push destination</strong> — when the export completes,
            Leadity fires the destination into Pipedrive.
          </li>
          <li>
            <strong>One-click push: each verified owner mobile becomes a Pipedrive Person tagged with industry + metro custom fields.</strong>
          </li>
          <li>
            <strong>Run outreach</strong> — DNC-scrubbed mobiles flow into your
            existing Pipedrive workflows for dialing, SMS, or sequencing.
          </li>
        </ol>

        <h2 className="text-2xl font-bold mt-12">Why pair Pipedrive with Leadity</h2>
        <ul className="mt-4 space-y-3 text-base">
          <li>
            <strong>Mobile-only data.</strong> 84%+ verified mobile rate via
            carrier HLR. Pipedrive workflows don't waste sends on landlines.
          </li>
          <li>
            <strong>TCPA flags inline.</strong> DNC + line-type tags pass
            through to Pipedrive as custom properties / fields. Build automations
            that respect compliance automatically.
          </li>
          <li>
            <strong>Flat pricing.</strong> $59 for 2,000 mobiles. No credit
            math — your Pipedrive cost stays predictable.
          </li>
        </ul>

        <h2 className="text-2xl font-bold mt-12">Set it up</h2>
        <p className="mt-4 text-base">
          The Pipedrive integration ships in Phase 8 production. The
          self-serve flow lives at <Link href="/dashboard" className="text-[#1B86FF] underline">
          /dashboard → Integrations → Pipedrive</Link>. For early access, reach
        ...
        <div className="mt-16 p-8 bg-[var(--color-surface)] rounded-2xl text-center">
          <h2 className="text-2xl font-bold">
            Try Leadity + Pipedrive — 50 mobiles free
          </h2>
