/**
 * /integrations/smartlead — Smartlead integration page
 *
 * High-DR backlink target + AI-citation landing page. Each integration
 * page targets the keyword cluster around "Smartlead + lead data" or
 * "Smartlead integration for cold outreach."
 */
...
export const metadata: Metadata = {
  title: "Smartlead Integration — Push Verified Owner Mobiles into Smartlead | Leadity",
  description:
    "Native Smartlead integration. Feed verified owner mobiles into Smartlead campaigns — cold SMS sequences that hit the owner directly, not the receptionist. Verified owner-direct mobiles, mobile-only filter, TCPA-aware export.",
  alternates: { canonical: "https://leadity.io/integrations/smartlead" },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Smartlead + Leadity: Verified Owner Mobiles in Your Smartlead Workflow",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Smartlead", item: "https://leadity.io/integrations/smartlead" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <p className="mt-6 text-xl leading-relaxed text-[var(--color-text-secondary)]">
          Verified owner-direct mobile numbers in your Smartlead workflow.
          Smartlead is a cold email + cold SMS sequencer — Feed verified owner mobiles into Smartlead campaigns — cold SMS sequences that hit the owner directly, not the receptionist.
        </p>
        ...
        <ol className="mt-4 space-y-3 text-base list-decimal list-inside">
          ...
          <li>
            <strong>Smartlead campaign import</strong> — when the export completes,
            Leadity fires the destination into Smartlead.
          </li>
          <li>
            <strong>CSV import or direct push. Smartlead's TCPA-aware sending pairs with Leadity's TCPA-aware export.</strong>
          </li>
          <li>
            <strong>Run outreach</strong> — DNC-scrubbed mobiles flow into your
            existing Smartlead workflows for dialing, SMS, or sequencing.
          </li>
        </ol>

        <h2 className="text-2xl font-bold mt-12">Why pair Smartlead with Leadity</h2>
        <ul className="mt-4 space-y-3 text-base">
          <li>
            <strong>Mobile-only data.</strong> 84%+ verified mobile rate via
            carrier HLR. Smartlead workflows don't waste sends on landlines.
          </li>
          <li>
            <strong>TCPA flags inline.</strong> DNC + line-type tags pass
            through to Smartlead as custom properties / fields. Build automations
            that respect compliance automatically.
          </li>
          <li>
            <strong>Flat pricing.</strong> $59 for 2,000 mobiles. No credit
            math — your Smartlead cost stays predictable.
          </li>
        </ul>

        <h2 className="text-2xl font-bold mt-12">Set it up</h2>
        <p className="mt-4 text-base">
          The Smartlead integration ships in Phase 8 production. The
          self-serve flow lives at <Link href="/dashboard" className="text-[#1B86FF] underline">
          /dashboard → Integrations → Smartlead</Link>. For early access, reach
        ...
        <div className="mt-16 p-8 bg-[var(--color-surface)] rounded-2xl text-center">
          <h2 className="text-2xl font-bold">
            Try Leadity + Smartlead — 50 mobiles free
          </h2>
