/**
 * /solutions/insurance-agents — Generated from Template C (vertical solution)
 *
 * Pay-per-lead vertical: insurance agents typically pay
 * $20-$60 per shared lead and $50-$200
 * per exclusive lead from EverQuote, QuoteWizard, NetQuote, MediaAlpha. This page reframes the math against
...
export const metadata: Metadata = {
  title: "Insurance Agent Leads — Mobile Numbers for $59 | Leadity",
  description:
    "Build a 2,000-insurance agent call list for $59 instead of $20-$200 per lead. Verified owner-direct mobile numbers. TCPA-aware export, niche x metro filtering, mobile-only.",
  alternates: {
    canonical: "https://leadity.io/solutions/insurance-agents",
  },
  openGraph: {
    title: "Insurance Agent Leads - $59 for 2,000 Owner Mobiles",
    description:
      "Stop paying $20-$200 per lead. Build your own insurance agent call list with verified owner mobile numbers.",
    type: "article",
    url: "https://leadity.io/solutions/insurance-agents",
    images: [{ url: "https://leadity.io/og/solutions-insurance-agents.png" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Insurance Agent Leads - Owner Mobiles for $59",
    description:
      "2,000 verified insurance agent mobile numbers for $59 flat. The pay-per-lead alternative.",
  },
};
  ...
  "@graph": [
    {
      "@type": "Article",
      headline:
        "Insurance Agent Leads: Build Your Own Call List for $59 Instead of $20-$200 Per Lead",
    ...
    },
    {
      ...
      audience: {
        ...
        audienceType: "Insurance agents, IMOs, and insurance recruiters",
      },
      description:
        "Verified owner-direct mobile phone numbers for US insurance agents. Sourced from Google Business Profiles, mobile-carrier verified, TCPA-aware export.",
      hasOfferCatalog: {
        "@type": "OfferCatalog",
        name: "Insurance Agent Leads Lists",
        itemListElement: [
          {
            "@type": "Offer",
            itemOffered: { "@type": "Service", name: "2,000 insurance agent owner mobiles" },
            price: "59",
            priceCurrency: "USD",
          },
          {
            "@type": "Offer",
            itemOffered: { "@type": "Service", name: "5,000 insurance agent owner mobiles" },
            price: "129",
            priceCurrency: "USD",
          },
          {
            "@type": "Offer",
            itemOffered: { "@type": "Service", name: "10,000 insurance agent owner mobiles" },
            price: "229",
            priceCurrency: "USD",
          },
        ],
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "How much do insurance agents leads cost from pay-per-lead networks?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Insurance agents, IMOs, and insurance recruiters leads from pay-per-lead networks (EverQuote, QuoteWizard, NetQuote, MediaAlpha) typically cost $20-$60 for shared leads and $50-$200 for exclusive leads. Leadity provides 2,000 verified insurance agent owner mobiles for $59 flat - that&rsquo;s less than a single shared lead in most categories, with 2,000 owner-direct dial opportunities.",
          },
        },
        {
          "@type": "Question",
          name: "What conversion rate should I expect from cold-calling insurance agents?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Cold-call conversion for insurance agents typically runs 2-3% from dial to appointment, depending on script quality, time of day, and offer. From 2,000 verified owner mobiles, that&rsquo;s 20-30 appointments. Even at the low end, the cost per appointment is well under what you&rsquo;d pay for a single exclusive lead from a pay-per-lead network.",
          },
        },
        {
          "@type": "Question",
          name: "Are these insurance agent leads exclusive?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is cold-calling insurance agents TCPA compliant?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I filter insurance agents by metro or state?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Leadity supports filtering by state, metro, ZIP, or custom polygon. Common targeting for insurance agents: all 50 states for P&C and life recruiting, with high-volume metros for senior agents (Atlanta, Dallas, Phoenix, Tampa, Charlotte) and licensing-friendly states for IMO recruiting.",
          },
        },
        {
          "@type": "Question",
          name: "What data fields do I get for each insurance agent?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Each Leadity record for insurance agents includes: business name, owner-direct mobile (mobile-only filtered), business address, Google Business Profile category (e.g., \"Insurance agency\"), Google review count + rating, business hours, website URL, year established (when available), service area radius, and TCPA flags (DNC status, line type, carrier).",
          },
        },
      ],
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Insurance Agent Leads", item: "https://leadity.io/solutions/insurance-agents" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <nav className="text-sm text-[var(--color-text-secondary)] mb-8">
          ...
          <span className="mx-2">/</span>
          <span>Insurance Agent Leads</span>
        </nav>

        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Insurance Agent Leads - <span className="text-brand-gradient">$59 for 2,000 Agent Mobiles</span>
        </h1>
        ...
        <p className="mt-8 text-xl leading-relaxed">
          Why pay $20-$200 per insurance lead when you can build a 2,000-agent recruiting list for $59? 2,000 verified owner-direct mobile numbers, sourced from
        ...
        <div className="mt-12 p-6 border-l-4 border-[#1B86FF] bg-[var(--color-surface)] rounded-r-2xl">
          ...
          <ul className="mt-4 space-y-2 text-base">
            <li>
              <strong>Pay-per-lead:</strong> $20-$60 per shared lead, $50-$200 per exclusive lead. To
        ...
        <h2 className="text-3xl font-bold mt-16">
          Where pay-per-lead breaks down for insurance agents
        </h2>
        <p className="mt-4 text-base">
          EverQuote, QuoteWizard, NetQuote, MediaAlpha all aggregate consumer demand and resell it as
        ...
        <h2 className="text-3xl font-bold mt-16">
          The Leadity workflow for insurance agents
        </h2>
        <ol className="mt-4 space-y-3 text-base list-decimal list-inside">
          <li>
            <strong>Pick your category</strong>: "Insurance agency" or related
            sub-categories within Leadity's 1,255+ US business taxonomy.
          </li>
          <li>
            <strong>Filter by geography</strong>: state, metro, ZIP, or custom
            polygon. all 50 states for P&C and life recruiting, with high-volume metros for senior agents (Atlanta, Dallas, Phoenix, Tampa, Charlotte) and licensing-friendly states for IMO recruiting.
          </li>
          <li>
        ...
        <p className="mt-4 text-base">
          B2B cold calls to insurance agents are generally TCPA-compliant
        ...
        <div className="mt-16 p-8 bg-[var(--color-surface)] rounded-2xl text-center">
          <h2 className="text-2xl font-bold">
            Try Leadity free - 50 insurance agent mobiles, no credit card
          </h2>
