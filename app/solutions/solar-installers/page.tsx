/**
 * /solutions/solar-installers — Generated from Template C (vertical solution)
 *
 * Pay-per-lead vertical: solar installers typically pay
 * $30-$80 per shared lead and $80-$200
 * per exclusive lead from Modernize, HomeAdvisor (Angi Leads), CraftJack, EnergySage. This page reframes the math against
...
export const metadata: Metadata = {
  title: "Solar Installer Leads — Owner Mobile Numbers for $59 | Leadity",
  description:
    "Build a 2,000-solar installer call list for $59 instead of $30-$200 per lead. Verified owner-direct mobile numbers. TCPA-aware export, niche x metro filtering, mobile-only.",
  alternates: {
    canonical: "https://leadity.io/solutions/solar-installers",
  },
  openGraph: {
    title: "Solar Installer Leads - $59 for 2,000 Owner Mobiles",
    description:
      "Stop paying $30-$200 per lead. Build your own solar installer call list with verified owner mobile numbers.",
    type: "article",
    url: "https://leadity.io/solutions/solar-installers",
    images: [{ url: "https://leadity.io/og/solutions-solar-installers.png" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Solar Installer Leads - Owner Mobiles for $59",
    description:
      "2,000 verified solar installer mobile numbers for $59 flat. The pay-per-lead alternative.",
  },
};
  ...
  "@graph": [
    {
      "@type": "Article",
      headline:
        "Solar Installer Leads: Build Your Own Call List for $59 Instead of $30-$200 Per Lead",
    ...
    },
    {
      ...
      audience: {
        ...
        audienceType: "Solar installers and solar lead resellers",
      },
      description:
        "Verified owner-direct mobile phone numbers for US solar installers. Sourced from Google Business Profiles, mobile-carrier verified, TCPA-aware export.",
      hasOfferCatalog: {
        "@type": "OfferCatalog",
        name: "Solar Installer Leads Lists",
        itemListElement: [
          {
            "@type": "Offer",
            itemOffered: { "@type": "Service", name: "2,000 solar installer owner mobiles" },
            price: "59",
            priceCurrency: "USD",
          },
          {
            "@type": "Offer",
            itemOffered: { "@type": "Service", name: "5,000 solar installer owner mobiles" },
            price: "129",
            priceCurrency: "USD",
          },
          {
            "@type": "Offer",
            itemOffered: { "@type": "Service", name: "10,000 solar installer owner mobiles" },
            price: "229",
            priceCurrency: "USD",
          },
        ],
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "How much do solar installers leads cost from pay-per-lead networks?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Solar installers and solar lead resellers leads from pay-per-lead networks (Modernize, HomeAdvisor (Angi Leads), CraftJack, EnergySage) typically cost $30-$80 for shared leads and $80-$200 for exclusive leads. Leadity provides 2,000 verified solar installer owner mobiles for $59 flat - that&rsquo;s less than a single shared lead in most categories, with 2,000 owner-direct dial opportunities.",
          },
        },
        {
          "@type": "Question",
          name: "What conversion rate should I expect from cold-calling solar installers?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Cold-call conversion for solar installers typically runs 2-4% from dial to appointment, depending on script quality, time of day, and offer. From 2,000 verified owner mobiles, that&rsquo;s 20-40 appointments. Even at the low end, the cost per appointment is well under what you&rsquo;d pay for a single exclusive lead from a pay-per-lead network.",
          },
        },
        {
          "@type": "Question",
          name: "Are these solar installer leads exclusive?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is cold-calling solar installers TCPA compliant?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I filter solar installers by metro or state?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Leadity supports filtering by state, metro, ZIP, or custom polygon. Common targeting for solar installers: sun-belt states (CA, AZ, FL, TX, NV), high-volume metros (Phoenix, Los Angeles, Tampa, Houston), and ZIP-level targeting in suburban single-family neighborhoods.",
          },
        },
        {
          "@type": "Question",
          name: "What data fields do I get for each solar installer?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Each Leadity record for solar installers includes: business name, owner-direct mobile (mobile-only filtered), business address, Google Business Profile category (e.g., \"Solar contractor\"), Google review count + rating, business hours, website URL, year established (when available), service area radius, and TCPA flags (DNC status, line type, carrier).",
          },
        },
      ],
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Solar Installer Leads", item: "https://leadity.io/solutions/solar-installers" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <nav className="text-sm text-[var(--color-text-secondary)] mb-8">
          ...
          <span className="mx-2">/</span>
          <span>Solar Installer Leads</span>
        </nav>

        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Solar Installer Leads - <span className="text-brand-gradient">$59 for 2,000 Owner Mobiles</span>
        </h1>
        ...
        <p className="mt-8 text-xl leading-relaxed">
          Why pay $30-$200 per solar lead when you can build a 2,000-installer call list for $59? 2,000 verified owner-direct mobile numbers, sourced from
        ...
        <div className="mt-12 p-6 border-l-4 border-[#1B86FF] bg-[var(--color-surface)] rounded-r-2xl">
          ...
          <ul className="mt-4 space-y-2 text-base">
            <li>
              <strong>Pay-per-lead:</strong> $30-$80 per shared lead, $80-$200 per exclusive lead. To
              run a 2,000-conversation outreach, you'd spend $50K+.
            </li>
            <li>
              <strong>Leadity:</strong> $59 flat for 2,000 verified owner mobiles.
              At 2-4% cold-call conversion, that's 20-40 appointments per
              campaign.
            </li>
          </ul>
        </div>
        ...
        <h2 className="text-3xl font-bold mt-16">
          Where pay-per-lead breaks down for solar installers
        </h2>
        <p className="mt-4 text-base">
          Modernize, HomeAdvisor (Angi Leads), CraftJack, EnergySage all aggregate consumer demand and resell it as
        ...
        <h2 className="text-3xl font-bold mt-16">
          The Leadity workflow for solar installers
        </h2>
        <ol className="mt-4 space-y-3 text-base list-decimal list-inside">
          <li>
            <strong>Pick your category</strong>: "Solar contractor" or related
            sub-categories within Leadity's 1,255+ US business taxonomy.
          </li>
          <li>
            <strong>Filter by geography</strong>: state, metro, ZIP, or custom
            polygon. sun-belt states (CA, AZ, FL, TX, NV), high-volume metros (Phoenix, Los Angeles, Tampa, Houston), and ZIP-level targeting in suburban single-family neighborhoods.
          </li>
          <li>
        ...
        <p className="mt-4 text-base">
          B2B cold calls to solar installers are generally TCPA-compliant
        ...
        <div className="mt-16 p-8 bg-[var(--color-surface)] rounded-2xl text-center">
          <h2 className="text-2xl font-bold">
            Try Leadity free - 50 solar installer mobiles, no credit card
          </h2>
