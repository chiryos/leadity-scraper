/**
 * /google-maps-phone-number-extractor — Generated from Template A (raw-keyword SEO landing)
 *
 * Targets: "Google Maps phone number extractor" + variations.
...
export const metadata: Metadata = {
  title: "Google Maps Phone Number Extractor — Mobile Only | Leadity",
  description:
    "Most Google Maps scrapers return whatever Google publishes — mostly receptionist landlines mixed with occasional mobile numbers. Leadity is purpose-built to extract only verified owner-direct mobile lines from Google Business Profiles, with carrier-level line-type lookup before delivery.",
  alternates: { canonical: "https://leadity.io/google-maps-phone-number-extractor" },
  openGraph: {
    title: "Google Maps Phone Number Extractor — Leadity",
    description: "Most Google Maps scrapers return whatever Google publishes — mostly receptionist landlines mixed with occasional mobile numbers. Leadity is purpose-built to extract only verified owner-direct mobile lines from Google Business Profiles, with carrier-level line-type lookup before delivery.",
    type: "article",
    url: "https://leadity.io/google-maps-phone-number-extractor",
  },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Google Maps Phone Number Extractor — Mobile Only | Leadity",
      ...
      mainEntityOfPage: { "@id": "https://leadity.io/google-maps-phone-number-extractor" },
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "What does Leadity do as a Google Maps phone number extractor?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is using a Google Maps phone number extractor legal in the US?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "How does Leadity compare to Outscraper or Apify as a Google Maps phone number extractor?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I integrate Google Maps phone number extractor output with my CRM?",
          acceptedAnswer: {
            "@type": "Answer",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Google Maps Phone Number Extractor", item: "https://leadity.io/google-maps-phone-number-extractor" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Google Maps Phone Number Extractor <span className="text-brand-gradient">that filters out landlines</span>
        </h1>
        ...
        <h2 className="text-3xl font-bold mt-16">How Google Maps phone number extractor works at Leadity</h2>
