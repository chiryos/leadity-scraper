/**
 * /local-business-leads — Generated from Template A (raw-keyword SEO landing)
 *
 * Targets: "local business leads" + variations.
...
export const metadata: Metadata = {
  title: "Local Business Leads — Owner Mobile Numbers from $59 | Leadity",
  description:
    "Local business leads with owner-direct mobile phone numbers, sourced from public Google Business Profiles across 2.4M+ US SMBs. Filter by 1,255+ categories, niche, ZIP, metro, or state. Carrier-verified mobile-only, TCPA-aware export.",
  alternates: { canonical: "https://leadity.io/local-business-leads" },
  openGraph: {
    title: "Local Business Leads — Leadity",
    description: "Local business leads with owner-direct mobile phone numbers, sourced from public Google Business Profiles across 2.4M+ US SMBs. Filter by 1,255+ categories, niche, ZIP, metro, or state. Carrier-verified mobile-only, TCPA-aware export.",
    type: "article",
    url: "https://leadity.io/local-business-leads",
  },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Local Business Leads — Owner Mobile Numbers from $59 | Leadity",
      ...
      mainEntityOfPage: { "@id": "https://leadity.io/local-business-leads" },
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "What does Leadity do as a local business leads?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is using a local business leads legal in the US?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "How does Leadity compare to Outscraper or Apify as a local business leads?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I integrate local business leads output with my CRM?",
          acceptedAnswer: {
            "@type": "Answer",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Local Business Leads", item: "https://leadity.io/local-business-leads" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Local Business Leads <span className="text-brand-gradient">with verified owner mobiles</span>
        </h1>
        ...
        <h2 className="text-3xl font-bold mt-16">How local business leads works at Leadity</h2>
