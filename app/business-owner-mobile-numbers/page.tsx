/**
 * /business-owner-mobile-numbers — Generated from Template A (raw-keyword SEO landing)
 *
 * Targets: "business owner mobile numbers" + variations.
...
export const metadata: Metadata = {
  title: "Business Owner Mobile Numbers — 2.4M+ Verified US Records",
  description:
    "Direct mobile phone numbers for owners and decision-makers at 2.4M+ US local businesses. Filtered for mobile-only via carrier-level lookup, exported with TCPA-aware flags. The fastest way to build a B2B cold-call list that actually reaches the owner.",
  alternates: { canonical: "https://leadity.io/business-owner-mobile-numbers" },
  openGraph: {
    title: "Business Owner Mobile Numbers — Leadity",
    description: "Direct mobile phone numbers for owners and decision-makers at 2.4M+ US local businesses. Filtered for mobile-only via carrier-level lookup, exported with TCPA-aware flags. The fastest way to build a B2B cold-call list that actually reaches the owner.",
    type: "article",
    url: "https://leadity.io/business-owner-mobile-numbers",
  },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Business Owner Mobile Numbers — 2.4M+ Verified US Records",
      ...
      mainEntityOfPage: { "@id": "https://leadity.io/business-owner-mobile-numbers" },
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "What does Leadity do as a business owner mobile numbers?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is using a business owner mobile numbers legal in the US?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "How does Leadity compare to Outscraper or Apify as a business owner mobile numbers?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I integrate business owner mobile numbers output with my CRM?",
          acceptedAnswer: {
            "@type": "Answer",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Business Owner Mobile Numbers", item: "https://leadity.io/business-owner-mobile-numbers" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Business Owner Mobile Numbers <span className="text-brand-gradient">for US local SMBs</span>
        </h1>
        ...
        <h2 className="text-3xl font-bold mt-16">How business owner mobile numbers works at Leadity</h2>
