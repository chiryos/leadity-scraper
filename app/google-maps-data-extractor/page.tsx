/**
 * /google-maps-data-extractor — Generated from Template A (raw-keyword SEO landing)
 *
 * Targets: "Google Maps data extractor" + variations.
...
export const metadata: Metadata = {
  title: "Google Maps Data Extractor — Mobile-Filtered, US-Only — Leadity",
  description:
    "Extract structured data from Google Business Profiles across 1,255+ US local business categories. Owner-direct mobile numbers, business address, GBP category, reviews, hours, website, year established — exported as clean CSV or pushed natively to your CRM.",
  alternates: { canonical: "https://leadity.io/google-maps-data-extractor" },
  openGraph: {
    title: "Google Maps Data Extractor — Leadity",
    description: "Extract structured data from Google Business Profiles across 1,255+ US local business categories. Owner-direct mobile numbers, business address, GBP category, reviews, hours, website, year established — exported as clean CSV or pushed natively to your CRM.",
    type: "article",
    url: "https://leadity.io/google-maps-data-extractor",
  },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Google Maps Data Extractor — Mobile-Filtered, US-Only — Leadity",
      ...
      mainEntityOfPage: { "@id": "https://leadity.io/google-maps-data-extractor" },
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "What does Leadity do as a Google Maps data extractor?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is using a Google Maps data extractor legal in the US?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "How does Leadity compare to Outscraper or Apify as a Google Maps data extractor?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I integrate Google Maps data extractor output with my CRM?",
          acceptedAnswer: {
            "@type": "Answer",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Google Maps Data Extractor", item: "https://leadity.io/google-maps-data-extractor" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Google Maps Data Extractor <span className="text-brand-gradient">with mobile-only filter built in</span>
        </h1>
        ...
        <h2 className="text-3xl font-bold mt-16">How Google Maps data extractor works at Leadity</h2>
