/**
 * /lead-scraper — Generated from Template A (raw-keyword SEO landing)
 *
 * Targets: "lead scraper" + variations.
...
export const metadata: Metadata = {
  title: "Lead Scraper for US B2B Cold Outreach — Leadity",
  description:
    "A lead scraper purpose-built for US B2B cold outreach: owner-direct mobile numbers from Google Business Profiles, carrier-verified mobile-only, TCPA-aware export, flat pay-as-you-go pricing. Skip the credit math of generic scrapers (Outscraper, Apify) and go straight to verified mobiles.",
  alternates: { canonical: "https://leadity.io/lead-scraper" },
  openGraph: {
    title: "Lead Scraper — Leadity",
    description: "A lead scraper purpose-built for US B2B cold outreach: owner-direct mobile numbers from Google Business Profiles, carrier-verified mobile-only, TCPA-aware export, flat pay-as-you-go pricing. Skip the credit math of generic scrapers (Outscraper, Apify) and go straight to verified mobiles.",
    type: "article",
    url: "https://leadity.io/lead-scraper",
  },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Lead Scraper for US B2B Cold Outreach — Leadity",
      ...
      mainEntityOfPage: { "@id": "https://leadity.io/lead-scraper" },
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "What does Leadity do as a lead scraper?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is using a lead scraper legal in the US?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "How does Leadity compare to Outscraper or Apify as a lead scraper?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I integrate lead scraper output with my CRM?",
          acceptedAnswer: {
            "@type": "Answer",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Lead Scraper", item: "https://leadity.io/lead-scraper" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Lead Scraper <span className="text-brand-gradient">built for SMB cold outreach</span>
        </h1>
        ...
        <h2 className="text-3xl font-bold mt-16">How lead scraper works at Leadity</h2>
