/**
 * /google-maps-email-extractor — Generated from Template A (raw-keyword SEO landing)
 *
 * Targets: "Google Maps email extractor" + variations.
...
export const metadata: Metadata = {
  title: "Google Maps Email Extractor — US Local Business Owners | Leadity",
  description:
    "Pull both owner-direct mobile and business email from Google Business Profile listings across 1,255+ US categories. Each record includes verified mobile (mobile-only filtered) plus matched business email when available — built for multi-channel outbound (cold call + cold email + cold SMS).",
  alternates: { canonical: "https://leadity.io/google-maps-email-extractor" },
  openGraph: {
    title: "Google Maps Email Extractor — Leadity",
    description: "Pull both owner-direct mobile and business email from Google Business Profile listings across 1,255+ US categories. Each record includes verified mobile (mobile-only filtered) plus matched business email when available — built for multi-channel outbound (cold call + cold email + cold SMS).",
    type: "article",
    url: "https://leadity.io/google-maps-email-extractor",
  },
};
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      headline: "Google Maps Email Extractor — US Local Business Owners | Leadity",
      ...
      mainEntityOfPage: { "@id": "https://leadity.io/google-maps-email-extractor" },
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        {
          "@type": "Question",
          name: "What does Leadity do as a Google Maps email extractor?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Is using a Google Maps email extractor legal in the US?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "How does Leadity compare to Outscraper or Apify as a Google Maps email extractor?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          name: "Can I integrate Google Maps email extractor output with my CRM?",
          acceptedAnswer: {
            "@type": "Answer",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Google Maps Email Extractor", item: "https://leadity.io/google-maps-email-extractor" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
          Google Maps Email Extractor <span className="text-brand-gradient">with phone + email matched</span>
        </h1>
        ...
        <h2 className="text-3xl font-bold mt-16">How Google Maps email extractor works at Leadity</h2>
