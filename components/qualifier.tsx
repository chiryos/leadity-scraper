      ...
      <div className="container-page relative">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 lg:grid-cols-2 lg:items-stretch">
          ...
          <Reveal delay={0.05} className="h-full">
            <article className="glass-card flex h-full flex-col rounded-[20px] p-8 md:p-10">
          ...
          <Reveal delay={0.12} className="h-full">
            ...
            >
              <article className="glass-card relative flex h-full flex-col rounded-[19px] p-8 md:p-10">
                <header className="flex items-center gap-3">
                  <span
                    aria-hidden
